...
int theCurrentShader = 0;
vector<string> theModelNames;
vector<string> theVsNames;
vector<string> theFsNames;
...
int main(int argc, char** argv)
{
   ...
   glm::mat4 projection = glm::perspective(glm::radians(60.0f), 1.0f, 0.1f, 10000.0f);
   ...
   while (!glfwWindowShouldClose(window))
   {
      ...
      glUniform3f(glGetUniformLocation(shaderId, "Kd"), 140.0f/255.0f, 247.0f/255.0f, 0.0f/255.0f);
      ...
      */
      ...
      glUniform3f(glGetUniformLocation(shaderId, "Kd"), 186.0f/255.0f, 155.0f/255.0f, 255.0f/255.0f);
      glUniform3f(glGetUniformLocation(shaderId, "Ka"), 0.1f, 0.1f, 0.1f);
